...
const [showfinish, setShowfinish] = useState(true)
  ...
  return (
    <>
      <Navbar />
      <div className=" max-md:container w-1/2 mx-auto my-5 rounded-xl p-5 bg-slate-500 min-h-[80vh] ">
      <h1 className='font-bold text-center text-xl'>Task Manager For You </h1>
